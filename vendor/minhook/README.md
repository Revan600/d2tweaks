...
- **v1.3.3 - 8 Jan 2017**
  * Added a helper function ```hookApiEx```. (Thanks to asm256)
...
- **v1.3.1-beta - 11 Mar 2015**
  * Added a helper function ```hookApi```. (Thanks to uniskz).
...
- **v1.2 - 28 Sep 2013**
  ...
  * Added the ```MH_RemoveHook``` function, which removes a hook created with the ```hook``` function.
